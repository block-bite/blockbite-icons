...
const presetflex_twocolumsfull = (props) => (
  <svg
  ...
  >
    ...
    <rect y={3} width={29} height={34} fill="black" />
    <rect x={31} y={3} width={29} height={34} fill="black" />
    <path
...
export default presetflex_twocolumsfull;
