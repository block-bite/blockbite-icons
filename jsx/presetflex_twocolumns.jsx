...
const presetflex_twocolumns = (props) => (
  <svg
  ...
  >
    ...
    <rect x={7} y={7} width={21} height={27} fill="black" />
    <rect x={32} y={7} width={21} height={27} fill="black" />
    <path
...
export default presetflex_twocolumns;
