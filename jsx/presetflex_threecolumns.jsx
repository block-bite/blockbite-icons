...
const presetflex_threecolumns = (props) => (
  <svg
  ...
  >
    ...
    <rect x={7} y={6} width={14} height={27} fill="black" />
    <rect x={23} y={6} width={14} height={27} fill="black" />
    <rect x={39} y={6} width={14} height={27} fill="black" />
    <path
    ...
    />
    <rect x={47.5} y={22.5} width={10} height={6} fill="black" />
    <rect x={47.5} y={30.5} width={10} height={6} fill="black" />
  </svg>
);

export default presetflex_threecolumns;
