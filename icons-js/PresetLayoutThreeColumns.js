export default function PresetsLayoutThreeColumns() {
    return (
        <svg width="60" height="40" viewBox="0 0 60 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="60" height="40" fill="white"/>
        <rect x="7" y="6" width="14" height="27" fill="#D9D9D9"/>
        <rect x="23" y="6" width="14" height="27" fill="#D9D9D9"/>
        <rect x="39" y="6" width="14" height="27" fill="#D9D9D9"/>
